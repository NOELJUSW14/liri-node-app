...
//   //Comman line array
 ...
 function spotifyThisSong(){
    spotify.search({ type: 'track', query: term }).then(function(data){
      var artistInfo = data.tracks.items[0];
      console.log(
       
    "Artist(s):" + artistInfo.artists[0].name,

    "Song Title:" + artistInfo.name,

    "Preview:" + artistInfo.preview_url,
 
    "Album Title:" + artistInfo.album.name
    )
    }).catch(function(error){
      if(error.response){
